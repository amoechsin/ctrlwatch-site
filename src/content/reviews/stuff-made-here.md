...
creator: Shane Wighton
dateline: "~2.4M subs · engineering / maker · infrequent (weeks to months between uploads)"
genre: Engineering / Maker
axes:
  contentQuality: 92
  consistency: 52
  replayValue: 88
...
overall: 86
verdict: EXCELLENT
pullQuote: "The machine always works. The man operating it is a disaster. That tension is the entire show."
...
This is Stuff Made Here, and it has been in our Top 50 since [Issue #001](/issues/001/). That longevity is not a courtesy — it is the magazine recording, with numerical precision, the fact that Wighton is doing something almost nobody else on the platform attempts.
...
The [Top 50](/top50/) has been right about this one since the beginning.

<!-- SEO/AEO METADATA BLOCK
Canonical URL: /reviews/stuff-made-here/
Title tag (57 chars): Stuff Made Here Review — Score 86/100 | CTRL+WATCH
Meta description (147 chars): CTRL+WATCH reviews Stuff Made Here: Shane Wighton's precision-engineering comedy scores 86/100 — EXCELLENT. Real machines, real failures, genuinely irreplaceable.
Schema JSON-LD:
{
  "@context": "https://schema.org",
  "@type": "Review",
  "name": "Stuff Made Here Review — Score 86/100 | CTRL+WATCH",
  "reviewBody": "Shane Wighton does not make videos about engineering. He makes videos about the particular agony of being a person who cannot leave a problem alone.",
  "author": {
    "@type": "Organization",
    "name": "CTRL+WATCH"
  },

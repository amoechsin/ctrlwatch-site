...
creator: Sam Denby
dateline: "~4.5M subs · logistics / economics / geography explainers · ~weekly"
genre: Logistics / Explainer
axes:
  contentQuality: 86
  consistency: 88
  replayValue: 78
...
overall: 84
verdict: EXCELLENT
pullQuote: "Wendover doesn't just explain how the world works — it explains why the world works that way, and the gap between those two questions is where all the interesting material lives."
...
Canonical URL: /reviews/wendover-productions/
Title tag (57 chars): Wendover Productions Review — Score 84/100 | CTRL+WATCH
Meta description (147 chars): Sam Denby's logistics and economics explainer ranks among YouTube's most rigorous — CTRL+WATCH scores it 84/100 EXCELLENT in our canonical Player Profile.
Schema JSON-LD:
{
  "@context": "https://schema.org",
  "@type": "Review",
  "name": "Wendover Productions — Player Profile",
  "reviewBody": "The most consistently rigorous logistics and economics explainer on the platform, operating at a level of research and argument that the vast majority of its genre peers don't approach.",
  "author": {
    "@type": "Organization",
    "name": "CTRL+WATCH"
  },

...
channel: NileRed
creator: Nigel Braun
dateline: "~4.6M subs · chemistry · long-form synthesis projects · monthly-ish"
genre: Chemistry
axes:
  contentQuality: 90
  consistency: 62
...
overall: 86
verdict: EXCELLENT
pullQuote: "NileRed is proof that the most compelling thing on YouTube isn't an event — it's a process, if you trust the audience enough to show them all of it."
originatingIssue: "#001"
related:
  - stuff-made-here
  - veritasium
updated: 2026-05-30
...
There is a scene in NileRed's video on making grape soda from rubber gloves — a title that sounds like satire but is entirely literal — where Nigel Braun holds up a small bottle of purple liquid, sniffs it, and says, in the flattest possible voice: "Yeah. That's grape." It took him forty-five minutes of screen time and several months of real time to arrive at that moment. He seems, genuinely, satisfied. The audience has been watching the whole time and feels the same way.
...
The flagship videos are the synthesis challenges: turning plastic into cologne, making cocaine from scratch (legally, with explicit DEA-disclaimer narration — a video that somehow made both the chemistry community and the algorithm very happy), attempting to synthesise vanillin from used motor oil. These projects run anywhere from twenty minutes to well over an hour. They do not condense. A multi-step reaction sequence gets each step at something close to real time, with Nigel narrating what he expects to happen and why, then showing what actually does. Failures are not cut around — they become episodes within the episode, often the most instructive ones.

The Nile Blue second channel functions as a lab notebook gone public: shorter videos, faster turnarounds, more exploratory content, less polish. If the main channel is the finished synthesis, Nile Blue is the messy notebook you'd flip through on the bench. Together they constitute a picture of a working chemist's mind that no textbook approximates.
...
**Canonical URL:** `/reviews/nilered/`

**Title tag (58 chars):** `NileRed Review — Score 86/100 | CTRL+WATCH`
...
```json
{
  ...
  "@type": "Review",
  "name": "NileRed Review — Score 86/100 | CTRL+WATCH",
  "reviewBody": "NileRed earns EXCELLENT with an overall score of 86/100. A long-form chemistry synthesis channel by Nigel Braun — methodical, unforced, and among YouTube's most distinctive science voices.",
  "reviewRating": {
    "@type": "Rating",
    "ratingValue": "86",
    "bestRating": "100",
  ...
  "itemReviewed": {
    "@type": "CreativeWork",
    "name": "NileRed",
    "description": "Long-form chemistry synthesis channel by Nigel Braun",
    "url": "https://www.youtube.com/@NileRed"
  },
  "about": {
    "@type": "Person",
  ...
  "url": "https://ctrl-watch.xyz/reviews/nilered/"
}
```

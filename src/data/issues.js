...
export const issues = [
  ...
  },
  {
    ...
    number: '#018',
    date: 'September 2026',
    title: 'THE HISTORY ISSUE',
    subtitle: 'YouTube quietly became the biggest history classroom ever built — and nobody checks the syllabus. We sent in the graders.',
    coverColor: '#FFE600',
    tag: 'HISTORY',
    rating: null,
    published: true,
    hero: 'heroes/018-hero.png',
    coverStar: 'yob',
    price: '£4.99',
    coverLines: [
      '▶ BOSS FIGHT: JOHNNY HARRIS vs VOX',
      '▶ FALL OF CIVILIZATIONS — STRAIGHT IN AT #16',
      '▶ HERODOTUS ANSWERS FOR HIS LIES',
    ],
    flashes: [
      { kind: 'tab',       text: 'HISTORY SPECIAL!',          color: '#FF2244' },
      { kind: 'starburst', text: 'NEW AT #16|SCORE 89',       color: '#FFE600' },
      { kind: 'sizzler',   text: '5 DEAD|HISTORIANS',         color: '#00F0FF' },
      { kind: 'banner',    text: 'THE INBOX IS REAL — WRITE IN', color: '#FF00AA' },

...
| _next: 2026-07-10_ | | | | | | | Confirm sitemap re-read (Discovered should jump toward 144). Request indexing (~6/day quota): `/issues/017/`, `/reviews/coffeezilla/`, `/reviews/ridddle/`, `/reviews/computerphile/`, `/reviews/dot-csv/`, `/vs/ai-explained-vs-two-minute-papers/`. Run `promote:status -- 017` at 48h post-execution. Watch whether nerdwriter1 impressions convert to a first click. |
